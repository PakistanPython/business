      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingLoan ? 'Update the details of your loan.' : 'Add a new loan to your records.'}
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({ ...formData, loan_type: value as 'personal' | 'business' | 'mortgage' | 'auto' | 'other' })}
                >
                  <SelectTrigger>
