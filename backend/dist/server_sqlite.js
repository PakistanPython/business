...
const auth_sqlite_1 = __importDefault(require("./routes/auth_sqlite"));
const dashboard_sqlite_1 = __importDefault(require("./routes/dashboard_sqlite"));
const income_sqlite_1 = __importDefault(require("./routes/income_sqlite"));
...
app.use('/api/dashboard', dashboard_sqlite_1.default);
app.use('/api/income', income_sqlite_1.default);
...
const startServer = async () => {
    try {
        await (0, database_sqlite_1.testConnection)();
        await (0, database_sqlite_1.initializeDatabase)();
        app.listen(PORT, () => {
