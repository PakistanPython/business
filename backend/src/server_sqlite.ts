...
import { testConnection, initializeDatabase } from './config/database_sqlite';

// Routes
import authRoutes from './routes/auth_sqlite';
import dashboardRoutes from './routes/dashboard_sqlite';
import incomeRoutes from './routes/income_sqlite';
...
import workScheduleRoutes from './routes/work_schedules';
import leaveRoutes from './routes/leaves';
import attendanceRuleRoutes from './routes/attendance_rules';
